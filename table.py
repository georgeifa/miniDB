...
#               ||===============================================================||
#               ||                                                               ||
#               ||          ΑΠΟ ΕΔΩ ΚΑΙ ΠΕΡΑ ΞΕΚΙΝΑΕΙ Ο ΝΕΟΣ ΚΩΔΙΚΑΣ             ||
#               ||                                                               ||
#               ||===============================================================||
                ...
                if not hasMatch:
                    for column_index_right in range(table_right._no_of_columns):
                        if table_right.column_types[column_index_right] != type("string"):
                            ...
                            print(f'## Join table name of index column. -> {join_table.column_names.index(f'{table_right._name}_{table_right.column_names[column_index_right]}')}')
